...
export function WeaponStoreView({ weapons, langs, legends }) {
  ...
  const Row = ({ index, data }) => {
    ...
    return (
      <div className={viewMode === 'grid' ? 'p-1 w-full h-[360px]' : 'p-0 px-2 min-h-[185px]'}>
        <div
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-100 dark:bg-slate-900" style={{ fontFamily: langs.font || 'BHLatinBold' }}>
      ...
      <div ref={detailPanelRef} className={`h-full lg:w-[65%] fixed inset-0 bg-black bg-opacity-50 z-50 lg:static lg:bg-transparent lg:flex lg:flex-col lg:gap-4 lg:shadow-none ${selectedWeapon ? 'block' : 'hidden lg:block'}`}>
