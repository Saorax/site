...
export function PodiumStoreView({ podiums, langs }) {
  ...
  const Row = ({ index, data }) => {
    ...
    return (
      <div className={viewMode === 'grid' ? 'p-1 w-full h-[260px]' : 'p-0 px-2 min-h-[160px]'}>
        ...
        >
          <ImageWithLoader src={`${host}/game/animPodium/${podium.podiumData?.PodiumID}/all/Ready`} alt="" className="h-32 w-32 rounded-lg bg-slate-900/80" />
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-gray-100 dark:bg-slate-900" style={{ fontFamily: langs.font || 'BHLatinBold' }}>
      ...
      <div ref={detailPanelRef} className={`h-full lg:w-[65%] fixed inset-0 bg-black bg-opacity-50 z-50 lg:static lg:bg-transparent lg:flex lg:flex-col lg:gap-4 lg:shadow-none ${selectedPodium ? 'block' : 'hidden lg:block'}`}>
        <div className="bg-white dark:bg-slate-900 p-3 lg:p-4 h-full overflow-y-auto relative">
          ...
          {selectedPodium ? (
            <div className="gap-2 flex flex-col">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="order-1 w-full flex flex-col gap-2 dark:bg-slate-800 bg-gray-100 p-2 rounded-lg">
                  <div className='dark:bg-slate-800 bg-gray-100 flex flex-col gap-2 p-2 rounded-lg'>
                    ...
                    <div className="mt-2 flex min-h-96 justify-center relative rounded-xl bg-slate-900/80 p-4">
              ...
              <RawDataDetails data={selectedPodium} />
            </div>
          ) : (
